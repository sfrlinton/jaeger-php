...
$serverSpan = $trace->startSpan('example HTTP', Reference::create(Reference::CHILD_OF, $spanContext));
...
$clientSapn1 = $clientTrace->startSpan('HTTP1', Reference::create(Reference::CHILD_OF, $spanContext));
...
$textMap = TextMap::create($_SERVER);
$spanContext = $clientTrace->extract(Propagator::TEXT_MAP, $textMap);
$clientSpan2 = $clientTrace->startSpan('HTTP2', Reference::create(Reference::CHILD_OF, $spanContext));
